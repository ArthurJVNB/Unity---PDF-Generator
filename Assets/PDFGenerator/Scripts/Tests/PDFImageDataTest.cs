	...
	public class PDFImageDataTest
	{
		...
		public void TestJson()
		{
			const string expected = "{\"type\":\"image\",\"src\":\"https://www.propixelgames.online/pdf/images/icon.png\"," +
				"\"style\":{\"display\":\"block\",\"margin\":\"20px auto\",\"width\":\"120px\",\"height\";\"120px\",\"border\":\"2px solid #2E86C1\",\"border-radius\":\"10px\",\"background-color\":\"#EAF2F8\",\"padding\":\"5px\"}}";
			var actual = new PDFImageData(null).SetUrl("https://www.propixelgames.online/pdf/images/icon.png")
				.AddStyle(ImageDisplayType.Block, 20, true, 120, 120).GetExportData().ToString(Formatting.None);
		...
		{
			const string expected = "\"style\":{\"display\":\"block\",\"margin\":\"20px auto\",\"width\":\"120px\",\"border\":\"2px solid #2E86C1\",\"border-radius\":\"10px\",\"background-color\":\"#EAF2F8\",\"padding\":\"5px\"}";
